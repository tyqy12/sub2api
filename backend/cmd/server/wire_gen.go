...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	performanceMonitor := service.ProvidePerformanceMonitor(concurrencyService, accountRepository, groupRepository)
	performanceHandler := admin.NewPerformanceHandler(performanceMonitor)
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, settingHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, performanceHandler)
	...
	gatewayHandler := handler.NewGatewayHandler(gatewayService, geminiMessagesCompatService, antigravityGatewayService, userService, concurrencyService, billingCacheService, performanceMonitor, configConfig)
